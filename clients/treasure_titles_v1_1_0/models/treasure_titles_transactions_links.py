"""Treasure Titles API model: Referências para outros recusos da API requisitada."""
...
T = TypeVar("T", bound="TreasureTitlesTransactionsLinks")


@_attrs_define
class TreasureTitlesTransactionsLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        treasure_titles_transactions_links = cls(
            self_=self_,
            first=first,
            prev=prev,
            next_=next_,
        ...
        treasure_titles_transactions_links.additional_properties = d
        return treasure_titles_transactions_links
