...
T = TypeVar("T", bound="TreasureTitlesLinks")


@_attrs_define
class TreasureTitlesLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        treasure_titles_links.additional_properties = d
        return treasure_titles_links
