"""Treasure Titles API model: Meta informações referente à API requisitada."""
...
T = TypeVar("T", bound="ResponseErrorMeta")


@_attrs_define
class ResponseErrorMeta:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        response_error_meta = cls(
            request_date_time=request_date_time,
        )

        response_error_meta.additional_properties = d
        return response_error_meta
