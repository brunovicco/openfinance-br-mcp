"""Treasure Titles API model: Valor líquido da transação"""
...
T = TypeVar("T", bound="TreasureTitlesTransactionNetValue")


@_attrs_define
class TreasureTitlesTransactionNetValue:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        treasure_titles_transaction_net_value = cls(
            amount=amount,
            currency=currency,
        )

        treasure_titles_transaction_net_value.additional_properties = d
        return treasure_titles_transaction_net_value
