"""ResponseTreasureTitlesBalances: a data model of the Treasure Titles API (Open Finance Brasil), per the OpenAPI spec's schema for it."""
...
T = TypeVar("T", bound="ResponseTreasureTitlesBalances")


@_attrs_define
class ResponseTreasureTitlesBalances:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = TreasureTitlesBalances.from_dict(d.pop("data"))

        links = TreasureTitlesLinks.from_dict(d.pop("links"))

        meta = TreasureTitlesMeta.from_dict(d.pop("meta"))

        response_treasure_titles_balances = cls(
            data=data,
            links=links,
            meta=meta,
        )

        return response_treasure_titles_balances
