"""Treasure Titles API - product_identification operation module: Obtém os dados da operação de Títulos do Tesouro Direto identificada por investmentId."""
...
) -> ResponseError | ResponseTreasureTitlesIdentifyProduct:
    if response.status_code == 200:
        response_200 = ResponseTreasureTitlesIdentifyProduct.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ResponseError | ResponseTreasureTitlesIdentifyProduct]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_fapi_interaction_id: str,
    x_customer_user_agent: str | Unset = UNSET,
) -> ResponseError | ResponseTreasureTitlesIdentifyProduct | None:
    """Obtém os dados da operação de Títulos do Tesouro Direto identificada por investmentId.
