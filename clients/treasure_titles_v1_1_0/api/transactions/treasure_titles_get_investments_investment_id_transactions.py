"""Treasure Titles API - transactions operation module: Obtém as movimentações da operação (últimos 12 meses) de Títulos do Tesouro Direto identificada por"""
...
def sync_detailed(
    ...
    *,
    ...
    """Obtém as movimentações da operação (últimos 12 meses) de Títulos do Tesouro Direto identificada por
    investmentId.
