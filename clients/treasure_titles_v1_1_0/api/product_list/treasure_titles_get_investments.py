"""Treasure Titles API - product_list operation module: Obtém a lista de operações de Títulos do Tesouro Direto mantidas pelo cliente na instituição"""
...
from clients.treasure_titles_v1_1_0.models.response_treasure_titles_list_product import (
...
) -> ResponseError | ResponseTreasureTitlesListProduct:
    if response.status_code == 200:
        response_200 = ResponseTreasureTitlesListProduct.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ResponseError | ResponseTreasureTitlesListProduct]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Obtém a lista de operações de Títulos do Tesouro Direto mantidas pelo cliente na instituição
    transmissora e para as quais ele tenha fornecido consentimento.
...
def sync(
    *,
    ...
    x_fapi_interaction_id: str,
    x_customer_user_agent: str | Unset = UNSET,
) -> ResponseError | ResponseTreasureTitlesListProduct | None:
    """Obtém a lista de operações de Títulos do Tesouro Direto mantidas pelo cliente na instituição
    transmissora e para as quais ele tenha fornecido consentimento.
