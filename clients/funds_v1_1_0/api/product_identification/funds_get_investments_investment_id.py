"""Funds API - product_identification operation module: Obtém os dados da operação de Fundos de Investimento identificada por investmentId."""
...
from clients.funds_v1_1_0.models.response_funds_product_identification import (
...
) -> ResponseErrorMetaSingle | ResponseFundsProductIdentification:
    if response.status_code == 200:
        response_200 = ResponseFundsProductIdentification.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ResponseErrorMetaSingle | ResponseFundsProductIdentification]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_fapi_interaction_id: str,
    x_customer_user_agent: str | Unset = UNSET,
) -> ResponseErrorMetaSingle | ResponseFundsProductIdentification | None:
    """Obtém os dados da operação de Fundos de Investimento identificada por investmentId.
