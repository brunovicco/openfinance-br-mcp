"""Funds API - product_list operation module: Obtém a lista de operações de Fundos de Investimento mantidas pelo cliente na instituição"""
...
) -> ResponseErrorMetaSingle | ResponseFundsProductList:
    if response.status_code == 200:
        response_200 = ResponseFundsProductList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ResponseErrorMetaSingle | ResponseFundsProductList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Obtém a lista de operações de Fundos de Investimento mantidas pelo cliente na instituição
...
def sync(
    *,
    ...
    x_fapi_interaction_id: str,
    x_customer_user_agent: str | Unset = UNSET,
) -> ResponseErrorMetaSingle | ResponseFundsProductList | None:
    """Obtém a lista de operações de Fundos de Investimento mantidas pelo cliente na instituição
    transmissora e para as quais ele tenha fornecido consentimento.
