...
T = TypeVar("T", bound="ResponseFundsTransactionsCurrentDataTransactionNetValue")


@_attrs_define
class ResponseFundsTransactionsCurrentDataTransactionNetValue:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        response_funds_transactions_current_data_transaction_net_value = cls(
            amount=amount,
            currency=currency,
        )

        response_funds_transactions_current_data_transaction_net_value.additional_properties = d
        return response_funds_transactions_current_data_transaction_net_value
