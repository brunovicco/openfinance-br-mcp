...
T = TypeVar("T", bound="FundsTransactionsLinks")


@_attrs_define
class FundsTransactionsLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        funds_transactions_links.additional_properties = d
        return funds_transactions_links
