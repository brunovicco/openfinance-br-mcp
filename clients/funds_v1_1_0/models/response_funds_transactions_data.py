...
T = TypeVar("T", bound="ResponseFundsTransactionsData")


@_attrs_define
class ResponseFundsTransactionsData:
    ...
    Attributes:
        ...
        type_ (EnumFundsTransactionsType): Tipo de movimentação (Entrada ou Saída).

            ENTRADA: APLICACAO, TRANSFERENCIA_COTAS,  OUTROS.

            SAIDA: RESGATE, COME_COTAS, TRANSFERENCIA_COTAS, AMORTIZACAO, OUTROS.
             Example: ENTRADA.
        transaction_type (EnumFundsTransactionsTransactionType): O campo deve classificar a transação de movimentação de
            investimento em um dos tipos descritos (amortização, transferência de cotas, aplicação, resgate ou come-cotas).
        ...
        transaction_quota_price (ResponseFundsTransactionsDataTransactionQuotaPrice): É o valor da cota utilizada na
            conversão para a realização da movimentação do cliente no fundo, conforme a regra prevista em regulamento -
            valor pode ser negativo.
        transaction_quota_quantity (str): Número de cotas convertidas na data da movimentação.
             Example: 42.25.
        transaction_value (ResponseFundsTransactionsDataTransactionValue): Valor solicitado pelo cliente.
        transaction_gross_value (ResponseFundsTransactionsDataTransactionGrossValue): Valor da movimentação que se
            refere a quantidade da cota x valor da cota da movimentação.
        ...
        income_tax (ResponseFundsTransactionsDataIncomeTax | Unset): Valor do Imposto de Renda (IR) retido na fonte
            ...
            valor 'SAIDA'.
        financial_transaction_tax (ResponseFundsTransactionsDataFinancialTransactionTax | Unset): Valor do Imposto sobre
            Operações Financeiras (IOF) retido na fonte considerando a alíquota vigente na data da movimentação.

            [Restrição] Campo de preenchimento obrigatório pelas participantes quando o campo 'type' for preenchido com o
            valor 'SAIDA'.
        transaction_exit_fee (ResponseFundsTransactionsDataTransactionExitFee | Unset): Valor da taxa de saída
            considerado na movimentação.

            [Restrição] Campo de preenchimento obrigatório pelas participantes quando o campo 'type' for preenchido com o
            valor 'SAIDA'.
        transaction_net_value (ResponseFundsTransactionsDataTransactionNetValue | Unset): Valor líquido da movimentação
            posterior à dedução de impostos (IOF e IR) e taxa de saída.
            [Restrição] Campo de preenchimento obrigatório pelas participantes quando o campo 'type' for preenchido com o
            valor 'SAIDA'.
    """

    transaction_id: str
    type_: EnumFundsTransactionsType
    ...
    income_tax: 'ResponseFundsTransactionsDataIncomeTax | Unset' = UNSET
    financial_transaction_tax: (
        'ResponseFundsTransactionsDataFinancialTransactionTax | Unset'
    ) = UNSET
    transaction_exit_fee: 'ResponseFundsTransactionsDataTransactionExitFee | Unset' = (
        UNSET
    )
    transaction_net_value: 'ResponseFundsTransactionsDataTransactionNetValue | Unset' = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = EnumFundsTransactionsType(d.pop("type"))
        ...
        transaction_quota_price = (
            ResponseFundsTransactionsDataTransactionQuotaPrice.from_dict(
        ...
        transaction_value = ResponseFundsTransactionsDataTransactionValue.from_dict(
            d.pop("transactionValue")
        )

        transaction_gross_value = (
            ResponseFundsTransactionsDataTransactionGrossValue.from_dict(
        ...
        income_tax: 'ResponseFundsTransactionsDataIncomeTax | Unset'
        if isinstance(_income_tax, Unset):
            income_tax = UNSET
        else:
            income_tax = ResponseFundsTransactionsDataIncomeTax.from_dict(_income_tax)
        ...
        if isinstance(_financial_transaction_tax, Unset):
            ...
            financial_transaction_tax = (
                ResponseFundsTransactionsDataFinancialTransactionTax.from_dict(
        ...
        if isinstance(_transaction_exit_fee, Unset):
            ...
            transaction_exit_fee = (
                ResponseFundsTransactionsDataTransactionExitFee.from_dict(
        ...
        if isinstance(_transaction_net_value, Unset):
            ...
            transaction_net_value = (
                ResponseFundsTransactionsDataTransactionNetValue.from_dict(
                    _transaction_net_value
                )
            )

        response_funds_transactions_data = cls(
        ...
        return response_funds_transactions_data
