...
T = TypeVar("T", bound="ResponseFundsTransactionsDataTransactionQuotaPrice")


@_attrs_define
class ResponseFundsTransactionsDataTransactionQuotaPrice:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        response_funds_transactions_data_transaction_quota_price = cls(
            amount=amount,
            currency=currency,
        )

        response_funds_transactions_data_transaction_quota_price.additional_properties = d
        return response_funds_transactions_data_transaction_quota_price
