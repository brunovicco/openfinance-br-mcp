"""ResponseFundsTransactionsCurrent: a data model of the Funds API (Open Finance Brasil), per the OpenAPI spec's schema for it."""
...
T = TypeVar("T", bound="ResponseFundsTransactionsCurrent")


@_attrs_define
class ResponseFundsTransactionsCurrent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = ResponseFundsTransactionsCurrentData.from_dict(data_item_data)
        ...
        response_funds_transactions_current = cls(
            data=data,
            links=links,
            meta=meta,
        )

        return response_funds_transactions_current
