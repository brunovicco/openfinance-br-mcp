"""Variable Incomes API model: Meta informações referente a API requisitada."""
...
T = TypeVar("T", bound="VariableIncomesMeta")


@_attrs_define
class VariableIncomesMeta:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        variable_incomes_meta = cls(
            total_records=total_records,
            total_pages=total_pages,
            request_date_time=request_date_time,
        )

        return variable_incomes_meta
