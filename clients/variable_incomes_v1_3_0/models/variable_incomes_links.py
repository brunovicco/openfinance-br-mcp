...
T = TypeVar("T", bound="VariableIncomesLinks")


@_attrs_define
class VariableIncomesLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        variable_incomes_links.additional_properties = d
        return variable_incomes_links
