"""Variable Incomes API model: Referências para outros recusos da API requisitada."""
...
T = TypeVar("T", bound="VariableIncomesTransactionsLinks")


@_attrs_define
class VariableIncomesTransactionsLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        variable_incomes_transactions_links = cls(
            self_=self_,
            first=first,
            prev=prev,
            next_=next_,
        ...
        variable_incomes_transactions_links.additional_properties = d
        return variable_incomes_transactions_links
