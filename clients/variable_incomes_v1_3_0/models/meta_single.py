"""Variable Incomes API model: Meta informação referente a API requisitada."""
...
T = TypeVar("T", bound="MetaSingle")


@_attrs_define
class MetaSingle:
    """Meta informação referente a API requisitada.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta_single.additional_properties = d
        return meta_single
