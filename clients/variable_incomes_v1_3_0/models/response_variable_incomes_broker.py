"""ResponseVariableIncomesBroker: a data model of the Variable Incomes API (Open Finance Brasil), per the OpenAPI spec's schema for it."""
...
if TYPE_CHECKING:
    from clients.variable_incomes_v1_3_0.models.response_variable_incomes_broker_data import (
...
T = TypeVar("T", bound="ResponseVariableIncomesBroker")


@_attrs_define
class ResponseVariableIncomesBroker:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = ResponseVariableIncomesBrokerData.from_dict(d.pop("data"))

        links = VariableIncomesLinks.from_dict(d.pop("links"))

        meta = VariableIncomesMeta.from_dict(d.pop("meta"))

        response_variable_incomes_broker = cls(
            data=data,
            links=links,
            meta=meta,
        )

        return response_variable_incomes_broker
