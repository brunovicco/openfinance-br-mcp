"""Variable Incomes API - balances operation module: Obtém a posição da operação de Renda Variável identificada por investmentId."""
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ResponseVariableIncomesBalances.from_dict(response.json())
    ...
    if response.status_code == 423:
        response_423 = (
            VariableIncomesGetInvestmentsInvestmentIdBalancesResponse423.from_dict(
                response.json()
            )
        )
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[ResponseErrorMetaSingle | ResponseVariableIncomesBalances | VariableIncomesGetInvestmentsInvestmentIdBalancesResponse423]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        ResponseErrorMetaSingle | ResponseVariableIncomesBalances | VariableIncomesGetInvestmentsInvestmentIdBalancesResponse423
    """
