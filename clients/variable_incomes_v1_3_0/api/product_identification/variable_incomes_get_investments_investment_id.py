"""Variable Incomes API - product_identification operation module: Obtém os dados da operação de Renda Variável identificada por investmentId."""
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ResponseVariableIncomesProductIdentification.from_dict(
            response.json()
        )
    ...
    if response.status_code == 423:
        response_423 = VariableIncomesGetInvestmentsInvestmentIdResponse423.from_dict(
            response.json()
        )
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[ResponseErrorMetaSingle | ResponseVariableIncomesProductIdentification | VariableIncomesGetInvestmentsInvestmentIdResponse423]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        ResponseErrorMetaSingle | ResponseVariableIncomesProductIdentification | VariableIncomesGetInvestmentsInvestmentIdResponse423
    """
