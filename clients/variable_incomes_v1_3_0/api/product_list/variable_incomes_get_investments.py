"""Variable Incomes API - product_list operation module: Obtém a lista de operações de Renda Variável mantidas pelo cliente na instituição transmissora e"""
...
from clients.variable_incomes_v1_3_0.models.response_variable_incomes_product_list import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ResponseVariableIncomesProductList.from_dict(response.json())
    ...
    if response.status_code == 423:
        response_423 = VariableIncomesGetInvestmentsResponse423.from_dict(
            response.json()
        )
...
def sync_detailed(
    *,
    ...
    """Obtém a lista de operações de Renda Variável mantidas pelo cliente na instituição transmissora e
    para as quais ele tenha fornecido consentimento.
    ...
    Returns:
        Response[ResponseErrorMetaSingle | ResponseVariableIncomesProductList | VariableIncomesGetInvestmentsResponse423]
    """
...
def sync(
    *,
    ...
    Returns:
        ResponseErrorMetaSingle | ResponseVariableIncomesProductList | VariableIncomesGetInvestmentsResponse423
    """
