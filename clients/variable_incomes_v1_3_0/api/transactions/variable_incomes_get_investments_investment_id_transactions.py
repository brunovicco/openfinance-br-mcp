"""Variable Incomes API - transactions operation module: Obtém as movimentações históricas (últimos 12 meses) da operação de Renda Variável identificada por"""
...
from clients.variable_incomes_v1_3_0.models.response_variable_incomes_transactions import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ResponseVariableIncomesTransactions.from_dict(response.json())
    ...
    if response.status_code == 423:
        response_423 = (
            VariableIncomesGetInvestmentsInvestmentIdTransactionsResponse423.from_dict(
                response.json()
            )
        )
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        from_transaction_date (datetime.date | Unset):  Example: 2022-01-01.
        to_transaction_date (datetime.date | Unset):  Example: 2022-12-31.
        authorization (str):
    ...
    Returns:
        Response[ResponseErrorMetaSingle | ResponseVariableIncomesTransactions | VariableIncomesGetInvestmentsInvestmentIdTransactionsResponse423]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        ResponseErrorMetaSingle | ResponseVariableIncomesTransactions | VariableIncomesGetInvestmentsInvestmentIdTransactionsResponse423
    """
