"""Bank Fixed Incomes API model: Meta informações referente a API requisitada."""
...
T = TypeVar("T", bound="BankFixedIncomesTransactionsMeta")


@_attrs_define
class BankFixedIncomesTransactionsMeta:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bank_fixed_incomes_transactions_meta = cls(
            request_date_time=request_date_time,
        )

        return bank_fixed_incomes_transactions_meta
