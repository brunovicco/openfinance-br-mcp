"""Bank Fixed Incomes API model: Meta informações referente à API requisitada."""
...
T = TypeVar("T", bound="ResponseErrorMetaSingleMeta")


@_attrs_define
class ResponseErrorMetaSingleMeta:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        response_error_meta_single_meta = cls(
            request_date_time=request_date_time,
        )

        response_error_meta_single_meta.additional_properties = d
        return response_error_meta_single_meta
