"""ResponseBankFixedIncomesBalances: a data model of the Bank Fixed Incomes API (Open Finance Brasil), per the OpenAPI spec's schema for it."""
...
T = TypeVar("T", bound="ResponseBankFixedIncomesBalances")


@_attrs_define
class ResponseBankFixedIncomesBalances:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = ResponseBankFixedIncomesBalancesData.from_dict(d.pop("data"))

        links = Links.from_dict(d.pop("links"))

        meta = BankFixedIncomesMeta.from_dict(d.pop("meta"))

        response_bank_fixed_incomes_balances = cls(
            data=data,
            links=links,
            meta=meta,
        )

        return response_bank_fixed_incomes_balances
