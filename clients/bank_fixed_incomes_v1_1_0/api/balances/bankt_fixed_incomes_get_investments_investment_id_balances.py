"""Bank Fixed Incomes API - balances operation module: Obtém a posição da operação de Renda Fixa Bancária identificada por investmentId."""
...
from clients.bank_fixed_incomes_v1_1_0.models.response_bank_fixed_incomes_balances import (
...
) -> ResponseBankFixedIncomesBalances | ResponseErrorMetaSingle:
    if response.status_code == 200:
        response_200 = ResponseBankFixedIncomesBalances.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ResponseBankFixedIncomesBalances | ResponseErrorMetaSingle]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_fapi_interaction_id: str,
    x_customer_user_agent: str | Unset = UNSET,
) -> ResponseBankFixedIncomesBalances | ResponseErrorMetaSingle | None:
    """Obtém a posição da operação de Renda Fixa Bancária identificada por investmentId.
