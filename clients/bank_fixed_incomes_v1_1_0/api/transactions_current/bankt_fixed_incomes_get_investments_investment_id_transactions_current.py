"""Bank Fixed Incomes API - transactions_current operation module: Obtém as movimentações recentes da operação de Renda Fixa Bancária identificada por investmentId. O"""
...
def sync_detailed(
    ...
    *,
    ...
    """Obtém as movimentações recentes da operação de Renda Fixa Bancária identificada por investmentId. O
