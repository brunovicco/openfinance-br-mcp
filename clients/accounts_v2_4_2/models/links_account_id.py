"""Accounts API model: Referências para outros recusos da API requisitada."""
...
T = TypeVar("T", bound="LinksAccountId")


@_attrs_define
class LinksAccountId:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        links_account_id.additional_properties = d
        return links_account_id
