"""Accounts API - accounts operation module: Obtém a lista de transações da conta identificada por accountId."""
...
def sync_detailed(
    ...
    *,
    ...
    consulta máxima que se estenda em 12 meses no passado mais 12 meses no futuro.
