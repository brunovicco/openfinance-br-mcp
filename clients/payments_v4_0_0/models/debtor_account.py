...
T = TypeVar("T", bound="DebtorAccount")
...
class DebtorAccount:
    ...
    iniciadora tenha coletado essas informações do cliente. Do contrário, será coletada na detentora e trazida para a
    iniciadora como resposta à criação do pagamento.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        debtor_account.additional_properties = d
