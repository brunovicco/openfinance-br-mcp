...
T = TypeVar("T", bound="ResponseCreatePixPaymentDataItemPayment")


@_attrs_define
class ResponseCreatePixPaymentDataItemPayment:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        response_create_pix_payment_data_item_payment = cls(
            amount=amount,
            currency=currency,
        )

        response_create_pix_payment_data_item_payment.additional_properties = d
        return response_create_pix_payment_data_item_payment
