...
T = TypeVar("T", bound="ResponsePixPaymentData")


@_attrs_define
class ResponsePixPaymentData:
    ...
    Attributes:
        ...
        ibge_town_code (str | Unset): O campo ibgetowncode no arranjo PIX, tem o mesmo comportamento que o campo codMun
            ...
            feriados estaduais e municipais no período em questão;
             Example: 5300108.
        rejection_reason (RejectionReasonGetPix | Unset): Motivo da rejeição do pagamento. Informações complementares
        ...
        cancellation (PixPaymentCancellation | Unset): Objeto que contém os dados referentes ao usuário pagador que
            solicitou o cancelamento, o canal utilizado por ele e o motivo.

            [Restrição] O objeto cancellation será obrigatório apenas quando o valor do campo status for igual a CANC.
        authorisation_flow (ResponsePixPaymentDataAuthorisationFlow | Unset): Campo condicional utilizado para
    ...
    rejection_reason: 'RejectionReasonGetPix | Unset' = UNSET
    transaction_identification: str | Unset = UNSET
    remittance_information: str | Unset = UNSET
    cancellation: 'PixPaymentCancellation | Unset' = UNSET
    authorisation_flow: ResponsePixPaymentDataAuthorisationFlow | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rejection_reason: 'RejectionReasonGetPix | Unset'
        if isinstance(_rejection_reason, Unset):
            rejection_reason = UNSET
        else:
            rejection_reason = RejectionReasonGetPix.from_dict(_rejection_reason)
        ...
        cancellation: 'PixPaymentCancellation | Unset'
        if isinstance(_cancellation, Unset):
            cancellation = UNSET
        else:
            cancellation = PixPaymentCancellation.from_dict(_cancellation)

        _authorisation_flow = d.pop("authorisationFlow", UNSET)
        authorisation_flow: ResponsePixPaymentDataAuthorisationFlow | Unset
        if isinstance(_authorisation_flow, Unset):
            authorisation_flow = UNSET
        else:
            authorisation_flow = ResponsePixPaymentDataAuthorisationFlow(
                _authorisation_flow
            )

        response_pix_payment_data = cls(
        ...
        response_pix_payment_data.additional_properties = d
        return response_pix_payment_data
