...
T = TypeVar("T", bound="PixPaymentCancellationCancelledByDocument")


@_attrs_define
class PixPaymentCancellationCancelledByDocument:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pix_payment_cancellation_cancelled_by_document = cls(
            identification=identification,
            rel=rel,
        )

        pix_payment_cancellation_cancelled_by_document.additional_properties = d
        return pix_payment_cancellation_cancelled_by_document
