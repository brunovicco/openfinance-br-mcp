...
T = TypeVar("T", bound="PatchPixPaymentDataCancellationCancelledByDocument")


@_attrs_define
class PatchPixPaymentDataCancellationCancelledByDocument:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_pix_payment_data_cancellation_cancelled_by_document = cls(
            identification=identification,
            rel=rel,
        )

        patch_pix_payment_data_cancellation_cancelled_by_document.additional_properties = d
        return patch_pix_payment_data_cancellation_cancelled_by_document
