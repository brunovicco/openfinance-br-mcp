...
T = TypeVar("T", bound="PatchPixPaymentCancellation")


@_attrs_define
class PatchPixPaymentCancellation:
    ...
    motivo.
        ...
        Attributes:
            ...
            cancelled_by (PatchPixPaymentCancellationCancelledBy): Informação relacionada ao usuário pagador que solicitou o
    ...
    cancelled_by: 'PatchPixPaymentCancellationCancelledBy'
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cancelled_by = PatchPixPaymentCancellationCancelledBy.from_dict(
            d.pop("cancelledBy")
        )

        patch_pix_payment_cancellation = cls(
            reason=reason,
        ...
        patch_pix_payment_cancellation.additional_properties = d
        return patch_pix_payment_cancellation
