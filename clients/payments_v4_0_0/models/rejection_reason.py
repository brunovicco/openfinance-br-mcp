...
class RejectionReason:
    ...
    [Restrição] Esse motivo deverá ser enviado quando o campo /data/status for igual a RJCT (REJECTED).
        ...
        Attributes:
            code (EnumRejectionReasonType): Define o código da razão pela qual o pagamento foi rejeitado
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        code = EnumRejectionReasonType(d.pop("code"))
        ...
        rejection_reason.additional_properties = d
