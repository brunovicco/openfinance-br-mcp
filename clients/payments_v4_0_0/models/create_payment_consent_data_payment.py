...
T = TypeVar("T", bound="CreatePaymentConsentDataPayment")


@_attrs_define
class CreatePaymentConsentDataPayment:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_payment_consent_data_payment = cls(
            type_=type_,
            currency=currency,
            amount=amount,
            details=details,
        ...
        create_payment_consent_data_payment.additional_properties = d
        return create_payment_consent_data_payment
