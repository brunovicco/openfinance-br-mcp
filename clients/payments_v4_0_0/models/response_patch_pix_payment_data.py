...
T = TypeVar("T", bound="ResponsePatchPixPaymentData")


@_attrs_define
class ResponsePatchPixPaymentData:
    ...
    Attributes:
        ...
        cancellation (PatchPixPaymentCancellation): Objeto que contém os dados referentes ao usuário pagador que
        ...
        authorisation_flow (ResponsePatchPixPaymentDataAuthorisationFlow | Unset): Campo condicional utilizado para
    ...
    authorisation_flow: ResponsePatchPixPaymentDataAuthorisationFlow | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cancellation = PatchPixPaymentCancellation.from_dict(d.pop("cancellation"))
        ...
        authorisation_flow: ResponsePatchPixPaymentDataAuthorisationFlow | Unset
        if isinstance(_authorisation_flow, Unset):
            authorisation_flow = UNSET
        else:
            authorisation_flow = ResponsePatchPixPaymentDataAuthorisationFlow(
                _authorisation_flow
            )

        response_patch_pix_payment_data = cls(
        ...
        response_patch_pix_payment_data.additional_properties = d
        return response_patch_pix_payment_data
