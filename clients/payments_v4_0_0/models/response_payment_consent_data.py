...
T = TypeVar("T", bound="ResponsePaymentConsentData")


@_attrs_define
class ResponsePaymentConsentData:
    ...
    Attributes:
        ...
        payment (PaymentConsent): Objeto contendo dados de pagamento para consentimento.
        ...
        rejection_reason (ConsentRejectionReason | Unset): Motivo da rejeição do consentimento. Informações
            complementares sobre o motivo do status.
    ...
    rejection_reason: 'ConsentRejectionReason | Unset' = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        payment = PaymentConsent.from_dict(d.pop("payment"))
        ...
        rejection_reason: 'ConsentRejectionReason | Unset'
        if isinstance(_rejection_reason, Unset):
            rejection_reason = UNSET
        else:
            rejection_reason = ConsentRejectionReason.from_dict(_rejection_reason)

        response_payment_consent_data = cls(
        ...
        response_payment_consent_data.additional_properties = d
        return response_payment_consent_data
