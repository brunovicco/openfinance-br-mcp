"""Credit Cards Accounts API model: Referências para outros recusos da API requisitada."""
...
T = TypeVar("T", bound="TransactionsLinks")
...
class TransactionsLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transactions_links.additional_properties = d
