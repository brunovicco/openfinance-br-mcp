"""Credit Cards Accounts API - credit_card operation module: Obtém os dados de identificação da conta identificada por creditCardAccountId."""
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/accounts/{credit_card_account_id}".format(
...
) -> ResponseCreditCardAccountsIdentification | ResponseError:
    if response.status_code == 200:
        response_200 = ResponseCreditCardAccountsIdentification.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ResponseCreditCardAccountsIdentification | ResponseError]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Obtém os dados de identificação da conta identificada por creditCardAccountId.
     ...
     Método para obter os dados de identificação da conta de pagamento pós-paga identificada por
...
def sync(
    ...
    *,
    ...
    x_fapi_interaction_id: UUID,
    x_customer_user_agent: str | Unset = UNSET,
) -> ResponseCreditCardAccountsIdentification | ResponseError | None:
    """Obtém os dados de identificação da conta identificada por creditCardAccountId.
