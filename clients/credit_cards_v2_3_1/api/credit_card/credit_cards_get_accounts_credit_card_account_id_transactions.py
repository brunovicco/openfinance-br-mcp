"""Credit Cards Accounts API - credit_card operation module: Obtém a lista de transações da conta identificada por creditCardAccountId."""
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/accounts/{credit_card_account_id}/transactions".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Obtém a lista de transações da conta identificada por creditCardAccountId.
     ...
     Método para obter a lista de transações histórica (últimos 12 meses, ou recorte desse período) da
    conta de pagamento pós-paga identificada por creditCardAccountId mantida pelo cliente na instituição
    transmissora.
