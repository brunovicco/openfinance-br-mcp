...
T = TypeVar("T", bound="ConsentsGetConsentsConsentIdResponse529Meta")


@_attrs_define
class ConsentsGetConsentsConsentIdResponse529Meta:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        consents_get_consents_consent_id_response_529_meta = cls(
            request_date_time=request_date_time,
        )

        return consents_get_consents_consent_id_response_529_meta
