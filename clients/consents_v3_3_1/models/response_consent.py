"""ResponseConsent: a data model of the Consents API (Open Finance Brasil), per the OpenAPI spec's schema for it."""
...
T = TypeVar("T", bound="ResponseConsent")
...
class ResponseConsent:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = ResponseConsentData.from_dict(d.pop("data"))
        ...
        response_consent = cls(
            data=data,
            links=links,
            meta=meta,
        )

        response_consent.additional_properties = d
        return response_consent
