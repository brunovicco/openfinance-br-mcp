"""ResponseConsentReadDataPermissionsItem: a data model of the Consents API (Open Finance Brasil), per the OpenAPI spec's schema for it."""

from enum import Enum


class ResponseConsentReadDataPermissionsItem(str, Enum):
