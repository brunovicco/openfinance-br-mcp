...
T = TypeVar("T", bound="ConsentsPostConsentsConsentIdExtendsResponse529Meta")


@_attrs_define
class ConsentsPostConsentsConsentIdExtendsResponse529Meta:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        consents_post_consents_consent_id_extends_response_529_meta = cls(
            request_date_time=request_date_time,
        )

        return consents_post_consents_consent_id_extends_response_529_meta
