"""ResponseConsentData: a data model of the Consents API (Open Finance Brasil), per the OpenAPI spec's schema for it."""
...
from clients.consents_v3_3_1.models.response_consent_data_permissions_item import (
...
T = TypeVar("T", bound="ResponseConsentData")


@_attrs_define
class ResponseConsentData:
    """
    Attributes:
        ...
        status (ResponseConsentDataStatus): Estado atual do consentimento cadastrado. Example: AWAITING_AUTHORISATION.
        status_update_date_time (datetime.datetime): Data e hora em que o recurso foi atualizado. Uma string com data e
            ...
            2021-05-21T08:30:00Z.
        permissions (list[ResponseConsentDataPermissionsItem]): Especifica os tipos de permissões de acesso às APIs no
            escopo do Open Finance Brasil - Dados cadastrais e transacionais, de acordo com os blocos de consentimento
    ...
    status: ResponseConsentDataStatus
    status_update_date_time: datetime.datetime
    permissions: list[ResponseConsentDataPermissionsItem]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = ResponseConsentDataStatus(d.pop("status"))
        ...
        for permissions_item_data in _permissions:
            permissions_item = ResponseConsentDataPermissionsItem(permissions_item_data)
        ...
        response_consent_data.additional_properties = d
        return response_consent_data
