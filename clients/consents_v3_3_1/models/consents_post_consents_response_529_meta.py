...
T = TypeVar("T", bound="ConsentsPostConsentsResponse529Meta")


@_attrs_define
class ConsentsPostConsentsResponse529Meta:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        consents_post_consents_response_529_meta = cls(
            request_date_time=request_date_time,
        )

        return consents_post_consents_response_529_meta
