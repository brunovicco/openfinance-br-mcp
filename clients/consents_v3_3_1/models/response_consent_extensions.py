"""ResponseConsentExtensions: a data model of the Consents API (Open Finance Brasil), per the OpenAPI spec's schema for it."""
...
T = TypeVar("T", bound="ResponseConsentExtensions")


@_attrs_define
class ResponseConsentExtensions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from clients.consents_v3_3_1.models.links_consents import LinksConsents
        from clients.consents_v3_3_1.models.meta import Meta
        from clients.consents_v3_3_1.models.response_consent_extensions_data import (
            ResponseConsentExtensionsData,
        )

        d = dict(src_dict)
        data = ResponseConsentExtensionsData.from_dict(d.pop("data"))
        ...
        response_consent_extensions = cls(
            data=data,
            links=links,
            meta=meta,
        )

        response_consent_extensions.additional_properties = d
        return response_consent_extensions
