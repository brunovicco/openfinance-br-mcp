"""Consents API - consents operation module: Obter detalhes do consentimento identificado por consentId."""
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/consents/{consent_id}".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> ConsentsGetConsentsConsentIdResponse529 | ResponseConsentRead | ResponseError:
    if response.status_code == 200:
        response_200 = ResponseConsentRead.from_dict(response.json())
    ...
    if response.status_code == 529:
        response_529 = ConsentsGetConsentsConsentIdResponse529.from_dict(
            response.json()
        )
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[ConsentsGetConsentsConsentIdResponse529 | ResponseConsentRead | ResponseError]
    """
...
def sync(
    ...
    *,
    ...
    ConsentsGetConsentsConsentIdResponse529 | ResponseConsentRead | ResponseError | None
):
    """Obter detalhes do consentimento identificado por consentId.
